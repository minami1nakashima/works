      ...
      items: [
        {
          ...
          map: map1,
          text: `市場の一角にある「ユッケ通り」
クァンジャン市場といえば、ユッケと韓国人でも答えるほど、
現地の方にも愛されています。
市場のサイドにはユッケ屋さんがずらりと並び、
どこのお店で食べてもおいしいです。
通りの中央には屋台が並び、ローカルフードを楽しむこともできます。
また、通りを抜けると普通の市場なので、
「キムチ」や「お土産」などを買うこともできます。
...
必ず値段を確認してから、周りの韓国人に助けを求めてもいいかも（若い人なら絶対助けてくれます。）`,
        },
        {
          ...
          map: map2,
          text: `韓国に行ったら絶対に食べてほしい韓国料理のひとつ！
「カンジャンケジャン」
日本人にはあまりなじみのないワタリガニですが、味は絶品です。
特に雌ガニがおいしいといわれ、
お店でも同じメニューなのに値段が分かれていることが多いです。
...
観光地では日本観光客向けの焼き肉屋を多く目にしますが、あまりオススメしません。`,
        },
        {
          ...
          map: map4,
          text: `韓国人にどんな民族？と聞くと、
100%の確率で配達（デリバリー）民族と答えるほど、
デリバリーが盛んな韓国
そんなデリバリー大国の中でも最も代表的なのが「チキン」です。
韓国には様々な味のチキンがありますが、
私がオススメするのはフライドチキン（一番オーソドックス）です。
ここのチキンは、ほかのチェーン店と
違いオリーブオイルで揚げており、とってもおいしいです。
BBQチキンは韓国では有名なチェーン店で、
ふと寄りやすいのもポイント
...
という方にオススメの料理です。
（日本のうどんに近い？）
カルグクスのほかにもポッサムや、ユッケなどの
お酒のつまみになるようなメニューもあるので、
現地のお年寄りに人気のお店です。
...
さっぱりとしたスープにスンデ＋レバーなどが入っており、
とてもおいしいです。
お好みでセウジョッ（アミの塩辛）や、
ダデギ（ニンニクや唐辛子、ネギを練ったもの）で
自分好みの味にして楽しみます。
...
（好みでチュックミなど追加ができます。）
辛いソースと食べるコンブルは、
豆もやしのシャキシャキと、豚肉が合わさってとてもおいしいです。
